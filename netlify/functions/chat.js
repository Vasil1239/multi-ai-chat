...
// Себестоимость 1 кредита в OpenRouter. Продаются по $0.001 (×10 → маржа +900%, с запасом на ×2.5 = +150% цель).
const CREDIT_VALUE_USD = 0.0001;
const MIN_CREDITS_PER_MESSAGE = 3; // минимум 3 кредита = $0.003, всегда ≥×2.5 к себестоимости даже коротких ответов
